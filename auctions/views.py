...
class CreateListingForm(forms.ModelForm):
    ...
    title = forms.CharField(label="Title", max_length=250, required=True, widget=forms.TextInput(attrs={
                                                                            "autocomplete": "off",
                                                                            "aria-label": "title",
                                                                            "class": "form-control"
                                                                        }))
    ...
    current_price = forms.DecimalField(label="Price", required=True, widget=forms.NumberInput(attrs={
...
def bid(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if (highest_bid is None and bid_price > auction.current_price ) or (highest_bid is not None and bid_price > highest_bid.bid_price):
                # Add new bid to db
